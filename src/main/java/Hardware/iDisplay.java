...
public class iDisplay {
    public static List<oshi.hardware.Display> GetDisplays() {
        ...
        List<oshi.hardware.Display> displays = si.getHardware().getDisplays();
        if (displays.isEmpty()) {
            return null;
        } else {
            return displays;
    ...
    public static String GetDisplayInformation(oshi.hardware.Display display, int id) {
        if (display == null) {
    ...
    public static String GetAllDisplayInformation() {
        List<oshi.hardware.Display> displays = GetDisplays();
